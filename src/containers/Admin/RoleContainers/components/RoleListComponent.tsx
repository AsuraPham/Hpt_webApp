...
export default class RoleListComponent extends React.Component<Props, any> {
  ...
  render() {
    const { roles, pagination, handleTableChange, isLoading, isOpenModalDelete } = this.props;
    return (
