...
export const UPLOAD_IMAGE_FILE = "You can only upload Image file!";
export const UPLOAD_SO_FILE = "You can only upload .so file!";
export const UPLOAD_FW_FILE = "You can only upload .fw file!";

export const PRINTER_DOES_NOT_EXIST = "Printer does not exist on system";
export const USER_DOES_NOT_EXIST = "User does not exist on system";

export const UPDATE_FIRMWARE_SUCCESS = "Update firmware successfully";
